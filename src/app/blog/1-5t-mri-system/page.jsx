...
<section className="article-body">
    <div className="container">
        ...
        <p>For the complete technical specification sheet, visit our <a href="/products/#mri" style={{color: 'var(--green)', fontWeight: '600'}}>product specification page</a>. To request a quotation, <a href="/quote/" style={{color: 'var(--green)', fontWeight: '600'}}>contact our sales team</a>.</p>
